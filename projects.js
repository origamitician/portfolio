$(document).ready(function(){ 
    let listOfProjects = [
        {date: "8/2023", project: "Stravalytics (Work In Progress)", description: "An interactive website that uses the Strava API to break down a users' run statistics into simple, yet detailed visualizations.", githubLink: "https://github.com/origamitician/run-visualizer", webLink: "https://stravalytics.cyclic.cloud", circleNum: 7, tags: ["personal", "visual", "mobile compatible"], uses: ["HTML", "CSS", "JS", "Strava API", "Node.js", "MongoDB"]},
